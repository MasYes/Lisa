package main.java.ru.lisaprog.classifiers;

//http://weka.sourceforge.net/doc.dev/
//http://weka.sourceforge.net/doc.stable/weka/classifiers/functions/LibSVM.html

import main.java.ru.lisaprog.articles.yandex.ArticleYandex;
import main.java.ru.lisaprog.articles.Article;
import main.java.ru.lisaprog.sql.SQLQuery;
import weka.core.*;
...
//	private LibSVM svm = new LibSVM();
	...
	public void addDocument(main.java.ru.lisaprog.objects.Vector vector, String classOfDocument){
	...
	public String classify(main.java.ru.lisaprog.objects.Vector vector) throws Exception{
	...
	private static Couple getMassives(main.java.ru.lisaprog.objects.Vector vector){

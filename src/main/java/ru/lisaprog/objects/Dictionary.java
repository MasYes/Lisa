package main.java.ru.lisaprog.objects;
...
import main.java.ru.lisaprog.articles.yandex.ReadArticleYandex;
...
//	private static HashSet<String> dict = SQLQuery.getWordsFromDict("dict_urls");
	...
	private static void addArticle(main.java.ru.lisaprog.objects.Vector vector){
